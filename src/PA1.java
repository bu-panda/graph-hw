	...
	implements GLEventListener, KeyListener, MouseListener, MouseMotionListener
{
	    ...
	    if ( button  == MouseEvent.BUTTON1 )
	    {
	    	...
	    	if (lineSegs.size()%2 == 1)
	    		...
	    		SketchBase.drawLine(buff, lineSegs.get(lineSegs.size()-2),
	    				lineSegs.get(lineSegs.size()-1), doTextureMap, texture);
	    }
	    ...
	    else if ( button == MouseEvent.BUTTON3 )
	    {
	    	...
	    	if (triangles.size()%3 == 1)
	    		...
	    		SketchBase.drawLine(buff, triangles.get(triangles.size()-2),
	    				triangles.get(triangles.size()-1), false, texture);
	...
	void lineTestPattern1()
	{
		...
		for(i=0,theta=0;i<n_steps;++i,theta += delta)
		{
			...
			SketchBase.drawLine(buff,v0,v1, doTextureMap, texture);
			SketchBase.drawLine(buff,v0,v2, doTextureMap, texture);
	    }
	}
	...
	void lineTestPattern3()
	{
		...
		for(i=0,theta=0;i<n_steps;++i,theta += delta)
		{
			...
			SketchBase.drawLine(buff,tri[0],tri[1], doTextureMap, texture);
			SketchBase.drawLine(buff,tri[1],tri[2], doTextureMap, texture);
			SketchBase.drawLine(buff,tri[0],tri[2], doTextureMap, texture);
	    }
	}
	void triTestPattern1(boolean doSmooth)
	{
		...
		for(i=0,theta=0;i<n_steps;++i,theta += delta)
	    {
			...
			SketchBase.drawTriangle(buff,tri[0],tri[1],tri[2],doSmooth, doFill, doTextureMap, texture);      
	    }
	}
